          ...
          <div class="card-body">
            <form action="addNewCustomer" method="post" id="form-login">
              <div class="form-group" style="margin-top: 10px;">
                ...
                <input type="text" class="form-control" id="fullname" placeholder="Enter the full name" required name="fullname">
              </div>
              <div class="form-group" style="margin-top: 10px;">
                <label for="address">Địa chỉ</label>
                <input type="text" id="address"  class="form-control"  name="address" placeholder="Enter the address" required>
              </div>
              <div class="form-group" style="margin-top: 10px;">
                <label for="group">Nhóm KH</label>
                <select class="custom-select my-1 mr-sm-2 form-control" id="group" required name ="group">
